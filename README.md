...
``` Bash
python src/continuous_trainer.py --mode ga \
    --width 64 --height 48 \
...
``` Bash
python src/continuous_trainer.py --mode rl --width 64 --height 48 --players 2 --opponent greedy --checkpoint_steps 50000 --learning_rate 3e-4 --n_steps 2048 --output_dir training_runs
```